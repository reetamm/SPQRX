...
SPQRX (Semi-Parametric Quantile Regression for eXtremes) performs bulk-and-tail density regression using neural networks. The package implements the methodology from [Majumder and Richards (2026)](https://link.springer.com/article/10.1007/s10687-026-00533-y), and is built around the `keras3` library in `R`.
...
You can install the development version of SPQRX from [GitHub](https://github.com/) with:
...
A minimum working example of fitting an SPQRX model to housing data in Arkansas, US, is provided below.
