...
Source:
[`DESCRIPTION`](https://github.com/reetamm/SPQRX/blob/main/DESCRIPTION)

Majumder R, Oxford D (2026). *SPQRX: SPQRX: Semi-Parametric Quantile
Regression for eXtremes*. R package version 0.1.0,
<https://reetamm.github.io/SPQRX/>.

    @Manual{,
      title = {SPQRX: SPQRX: Semi-Parametric Quantile Regression for eXtremes},
